...
class StorageProvider(BaseProvider):
    ...
    STORAGE_TYPES = {
        "basic": "aries_cloudagency.storage.basic.BasicStorage",
        "indy": "aries_cloudagency.storage.indy.IndyStorage",
        "postgres_storage": "aries_cloudagency.storage.indy.IndyStorage",
    }
