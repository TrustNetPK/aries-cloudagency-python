...
from aries_cloudagency.cache.base import BaseCache
from aries_cloudagency.cache.basic import BasicCache
from aries_cloudagency.config.base import InjectorError
from aries_cloudagency.ledger.base import BaseLedger
from aries_cloudagency.config.injection_context import InjectionContext
from aries_cloudagency.connections.models.connection_record import ConnectionRecord
from aries_cloudagency.connections.models.connection_target import ConnectionTarget
from aries_cloudagency.connections.models.diddoc import (
    DIDDoc,
    PublicKey,
    PublicKeyType,
    Service,
...
from aries_cloudagency.ledger.base import BaseLedger
from aries_cloudagency.messaging.responder import BaseResponder, MockResponder
from aries_cloudagency.storage.base import BaseStorage
from aries_cloudagency.storage.basic import BasicStorage
...
from aries_cloudagency.wallet.base import BaseWallet, DIDInfo
from aries_cloudagency.wallet.basic import BasicWallet
from aries_cloudagency.wallet.error import WalletNotFoundError

from aries_cloudagency.protocols.routing.v1_0.manager import RoutingManager
...
from aries_cloudagency.protocols.connections.v1_0.manager import ConnectionManager
...
class TestOOBManager(AsyncTestCase, TestConfig):
    ...
    async def test_receive_invitation_bad_service_length(self):
        ...
        with async_mock.patch.object(
            ...
            "aries_cloudagency.protocols.out_of_band.v1_0.manager.InvitationMessage",
            autospec=True,
        ) as inv_message_cls:
            mock_wallet_get_public_did.return_value = DIDInfo(
                self.test_did, self.test_verkey, None
    ...
    async def test_receive_invitation_service_block(self):
        ...
        with async_mock.patch.object(
            ...
            "aries_cloudagency.protocols.out_of_band.v1_0.manager.ConnectionInvitation",
            autospec=True,
        ) as conn_inv_cls:
            mock_wallet_get_public_did.return_value = DIDInfo(
                self.test_did, self.test_verkey, None
