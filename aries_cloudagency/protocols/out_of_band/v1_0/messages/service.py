...
from aries_cloudagency.messaging.models.base import BaseModel, BaseModelSchema
from aries_cloudagency.messaging.valid import INDY_DID, INDY_RAW_PUBLIC_KEY
