...
from aries_cloudagency.cache.basic import BasicCache
from aries_cloudagency.issuer.base import BaseIssuer, IssuerError
from aries_cloudagency.ledger.indy import (
...
from aries_cloudagency.storage.indy import IndyStorage
from aries_cloudagency.storage.record import StorageRecord
from aries_cloudagency.wallet.base import DIDInfo
...
class TestIndyLedger(AsyncTestCase):
    ...
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._context_open")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._context_close")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._submit")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger.fetch_schema_by_id")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger.fetch_schema_by_seq_no")
    @async_mock.patch("aries_cloudagency.storage.indy.IndyStorage.add_record")
    ...
    @async_mock.patch("indy.pool.open_pool_ledger")
    @async_mock.patch("indy.pool.close_pool_ledger")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger.check_existing_schema")
    @async_mock.patch("aries_cloudagency.storage.indy.IndyStorage.add_record")
    @async_mock.patch("indy.ledger.build_schema_request")
    ...
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger.get_schema")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._context_open")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._context_close")
    @async_mock.patch(
        "aries_cloudagency.ledger.indy.IndyLedger.fetch_credential_definition"
    )
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._submit")
    @async_mock.patch("aries_cloudagency.storage.indy.IndyStorage.search_records")
    @async_mock.patch("aries_cloudagency.storage.indy.IndyStorage.add_record")
    ...
    @async_mock.patch("indy.ledger.build_get_nym_request")
    @async_mock.patch("indy.ledger.build_get_txn_request")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger.register_nym")
    @async_mock.patch("aries_cloudagency.ledger.indy.IndyLedger._submit")
