...
class DefaultContextBuilder(ContextBuilder):
    ...
    async def bind_providers(self, context: InjectionContext):
        ...
        context.injector.bind_provider(
            ...
            StatsProvider(
                ClassProvider(
                    "aries_cloudagency.issuer.indy.IndyIssuer",
        ...
        context.injector.bind_provider(
            ...
            StatsProvider(
                ClassProvider(
                    "aries_cloudagency.holder.indy.IndyHolder",
                    ClassProvider.Inject(BaseWallet),
                ),
        ...
        context.injector.bind_provider(
            BaseVerifier,
            ClassProvider(
                "aries_cloudagency.verifier.indy.IndyVerifier",
        ...
        context.injector.bind_provider(
            ...
            CachedProvider(
                StatsProvider(
                    ClassProvider(
                        "aries_cloudagency.transport.pack_format.PackWireFormat"
                    ),
                    (
    ...
    async def load_plugins(self, context: InjectionContext):
        ...
        plugin_registry.register_package("aries_cloudagency.protocols")

        # Currently providing admin routes only
        plugin_registry.register_plugin("aries_cloudagency.holder")
        plugin_registry.register_plugin("aries_cloudagency.ledger")
        plugin_registry.register_plugin(
            "aries_cloudagency.messaging.credential_definitions"
        )
        plugin_registry.register_plugin("aries_cloudagency.messaging.schemas")
        plugin_registry.register_plugin("aries_cloudagency.revocation")
        plugin_registry.register_plugin("aries_cloudagency.wallet")
